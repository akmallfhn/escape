    ...
    return (
        <section className="relative bg-black">
            <div className="relative mx-auto flex max-w-7xl flex-col">
                {/* hero image full width — locked to 1440:900 (16:10) ratio so bg-contain fills exactly */}
                <div className="relative w-full mb-10" style={{ aspectRatio: '1440/900' }}>
                    <div className="absolute inset-0 z-0 bg-[url('/images/hero.png')] bg-contain bg-center bg-no-repeat md:bg-[url('/images/hero.png')]" />
